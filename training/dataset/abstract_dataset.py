...
class DeepfakeAbstractBaseDataset(data.Dataset):
    ...
    def load_landmark(self, file_path):
        ...
        if os.path.exists(file_path):
            ...
            scaling_factor = np.array(new_size) / np.array(256)
            landmark = landmark * scaling_factor
    ...
    def __getitem__(self, index):
        ...
        name_list.append(self.data_dict['name'][index])

        return image_tensors, label, landmark_tensors, mask_tensors, name_list
