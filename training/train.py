...
parser.add_argument('--detector_path', type=str,
                    default='/data/home/zhiyuanyan/DeepfakeBench/training/config/detector/clip_adapter.yaml',
...
def prepare_training_data(config):
    ...
    if config['model_name'] == 'lsda':
        from training.dataset.lsda_dataset import CustomSampler
